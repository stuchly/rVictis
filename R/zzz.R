#' @useDynLib rVictis, .registration = TRUE
...
.onLoad<-function(libname,pckgname){
  if (any(c(!reticulate::py_module_available("tensorflow"),
    ...
    if (!reticulate::py_module_available("vaevictis")) reticulate::py_install("git+https://github.com/stuchly/vaevictis.git@064298160bdf1f9eb9ea5b427d66de1b2207c781",pip=TRUE)
  }
